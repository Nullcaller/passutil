...
static unsigned short memorize_choice_count = 2;

#define FACILITIES_MEMORIZE_SYMBOL_FAILURE_MODE_IGNORE 0
#define FACILITIES_MEMORIZE_SYMBOL_FAILURE_MODE_REPEAT 1
#define FACILITIES_MEMORIZE_SYMBOL_FAILURE_MODE_RESTART 2

static unsigned short memorize_symbol_failure_mode = FACILITIES_MEMORIZE_SYMBOL_FAILURE_MODE_REPEAT;
...
#define FACILITIES_TO_MEMORIZATION_INVALID_MODE					62
#define FACILITIES_TO_MEMORIZATION_INVALID_SYMBOL_FAILURE_MODE	63
#define FACILITIES_TO_MEMORIZATION_INVALID_REPEAT_MODE			64
#define FACILITIES_TO_MEMORIZATION_INVALID_SYMBOL_NUMBER		65
#define FACILITIES_TO_MEMORIZATION_INVALID_CHOICE_COUNT			66
